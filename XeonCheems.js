...
//[target]\\
	const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://chat.whatsapp.com/GsuP6Mw4jjs7qm4XtXkwAd"}}}, { quoted: m})
        }
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
	    ...
	    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                XeonBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/987d16587ca7174e66d9d.jpg' }, caption: `*Hi bro ${m.pushName}*\n\n Bot Rental Price\n⭔ 10k Per Group via Gpay/paytm/phonepe 1 Month\n\nFor more details, you can chat with the owner\nhttps://wa.me/6283819082780 (Owner)\n\nDonate Me : \n\n⭔ Fampay : https://telegra.ph/file/987d16587ca7174e66d9d.jpg\n⭔ Paytm : https://telegra.ph/file/987d16587ca7174e66d9d.jpg` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply('Script : https://github.com/Vikoleonidas/KyurazV4-MD\n Dont Forget To Give Star\n\nYoutube : https://youtu.be/imFIX-Wrt3s\n Dont Forget To Subscribe')
            }
            break
            case 'chat': {
...
case 'antilink':
 ...
 reply(`Pilih Antilink On / Off `)
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'YouTube',
                                    url: 'https://github.com/Vikoleonidas/KyurazV4-MD'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Owner Number👤',
                                    phoneNumber: '+62 838-1908-2780'
                                }
                            }, {
                                quickReplyButton: {
            ...
            case 'bc': case 'broadcast': case 'bcall': {
                if (!isCreator) throw mess.owner
                if (!text) throw `Where is the text?\n\nExample : ${prefix + command} Kyuraz bot here`
	    ...
	    case 'anonymous': {
				...
				let buttons = [{
                                urlButton: {
                                    ...
                                    url: 'https://wa.me/6283819082780?text=hello+bro+i+found+a+bug+in+your+bot'
                                }
                            }, {
                                quickReplyButton: {
...
reply(`Successfully Reported To The Owner\n\nPlease Make Sure The Bug Is Valid, If You Play With This, Use This Feature Again And Again For No Reason, You Will Be Blocked For Sure !`)
                    ...
                    break 
case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'Kyuraz': case 'Ryutenzo':{
                anu = `Hi ${pushname}
Kyuraz Bot With You Forever!! 😅🤚`
